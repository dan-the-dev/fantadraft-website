                ...
                <div className="flex flex-col items-center sm:px-5 lg:flex-row">
                    <div className="w-full md:w-1/2">
                        <a href="#_" className="block">
                            <Image src={'/blog/cos-e-fantadraft-la-rivoluzione-del-fantacalcio.jpeg'} layout="responsive" width={'500'} height={'400'} onClick={() => {router.push('/en/blog/cos-e-fantadraft-la-rivoluzione-del-fantacalcio')}}/>
                        </a>
                    </div>
