                ...
                <div className="flex flex-col items-center sm:px-5 lg:flex-row">
                    ...
                    <div className="flex flex-col items-start justify-center w-full h-full py-6 mb-6 md:mb-0 md:w-1/2">
                        <div className="flex flex-col items-start justify-center h-full space-y-3 transform md:pl-10 lg:pl-16 md:space-y-5">
                            ...
                            <h1 className="cursor-pointer text-4xl font-bold leading-none lg:text-5xl xl:text-6xl" onClick={() => {router.push('/en/blog/come-funziona-fantadraft')}}>Game mechanics</h1>
                            <p className="pt-2 text-sm font-medium text-secondary"><span className="mx-1">20th of June 2022</span> · <span className="mx-1">10 min. read</span></p>
                            <p className="pt-2 text-xs">
                                The Kickstarter campaign will launch after the summer, and it's time to tell you how the new fantasy football will work!
                            </p>
                        </div>
