                ...
                <div className="flex flex-col items-center sm:px-5 lg:flex-row">
                    <div className="w-full md:w-1/2">
                        <a href="#_" className="block">
                            <Image src={'/blog/cos-e-fantadraft-la-rivoluzione-del-fantacalcio.jpeg'} layout="responsive" width={'500'} height={'400'} />
                        </a>
                    </div>
                    <div className="flex flex-col items-start justify-center w-full h-full py-6 mb-6 md:mb-0 md:w-1/2">
                        <div className="flex flex-col items-start justify-center h-full space-y-3 transform md:pl-10 lg:pl-16 md:space-y-5">
                            ...
                            <h1 className="text-4xl font-bold leading-none lg:text-5xl xl:text-6xl"><a href="#_">Fantadraft: Fantasy Football revolution</a></h1>
