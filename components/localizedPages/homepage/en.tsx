                ...
                <div className="flex flex-col items-center sm:px-5 lg:flex-row">
                    <div className="w-full md:w-1/2">
                        <a href="#_" className="block">
                            <Image src={'/blog/evoluzioni-idea-decisioni-prese.jpg'} layout="responsive" width={'500'} height={'400'} onClick={() => {router.push('/en/blog/evoluzioni-idea-decisioni-prese')}}/>
                        </a>
                    </div>
                    <div className="flex flex-col items-start justify-center w-full h-full py-6 mb-6 md:mb-0 md:w-1/2">
                        <div className="flex flex-col items-start justify-center h-full space-y-3 transform md:pl-10 lg:pl-16 md:space-y-5">
                            ...
                            <h1 className="cursor-pointer text-4xl font-bold leading-none lg:text-5xl xl:text-6xl" onClick={() => {router.push('/en/blog/evoluzioni-idea-decisioni-prese')}}>Evolution of the idea and decisions already made</h1>
                            <p className="pt-2 text-sm font-medium text-secondary"><span className="mx-1">13th of June 2022</span> · <span className="mx-1">8 min. read</span></p>
                        ...
                        <div className="flex h-full w-full pt-5 md:pl-10 lg:pl-16">
                            <button className="btn bg-secondary text-primary hover:bg-primary hover:text-secondary hover:border-secondary" onClick={() => {router.push('/en/blog/evoluzioni-idea-decisioni-prese')}}>Read more</button>
