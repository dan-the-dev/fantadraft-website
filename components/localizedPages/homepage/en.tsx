      ...
      <section className="w-full px-3 antialiased bg-primary lg:px-6">
          <div className="mx-auto max-w-7xl flex flex-col md:flex-row justify-center py-4">
            ...
            <div className="container py-10 mx-auto text-center sm:px-4 col-span-3">
                <h1 className="text-4xl font-extrabold leading-10 tracking-tight text-secondary sm:text-5xl sm:leading-none md:text-6xl xl:text-7xl"><span className="block">Discover a whole new</span> <span className="relative inline-block mt-3 text-secondary">Fantasy Football experience</span></h1>
                ...
                <div className="flex flex-col items-center sm:px-5 md:flex-row">
                    ...
                    <div className="flex flex-col items-start justify-center w-full h-full py-6 mb-6 md:mb-0 md:w-1/2">
                        <div className="flex flex-col items-start justify-center h-full space-y-3 transform md:pl-10 lg:pl-16 md:space-y-5">
                            ...
                            <h1 className="text-4xl font-bold leading-none lg:text-5xl xl:text-6xl"><a href="#_">What is Fantadraft: the fantasy football revolution.</a></h1>
                        ...
                        <div className="flex h-full w-full pt-5 md:pl-10 lg:pl-16">
                            <button className="btn bg-secondary text-primary hover:bg-primary hover:text-secondary hover:border-secondary" onClick={() => {router.push('/blog/cos-e-fantadraft-la-rivoluzione-del-fantacalcio')}}>Read more</button>
