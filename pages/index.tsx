      ...
      <section className="w-full px-3 antialiased bg-indigo-600 lg:px-6">
          <div className="mx-auto max-w-7xl">
              ...
              <div className="container py-32 mx-auto text-center sm:px-4">
                  ...
                  <h1 className="text-4xl font-extrabold leading-10 tracking-tight text-white sm:text-5xl sm:leading-none md:text-6xl xl:text-7xl"><span className="block">Scopri un fantacalcio</span> <span className="relative inline-block mt-3 text-white">tutto nuovo</span></h1>
                  ...
                  <div className="relative flex items-center max-w-lg mx-auto mt-12 overflow-hidden text-center rounded-full">
                      ...
                      <span className="relative top-0 right-0 block">
                          <button type="button" className="inline-flex items-center w-56 h-12 px-8 text-base font-bold leading-6 text-white transition duration-150 ease-in-out bg-indigo-400 border border-transparent hover:bg-indigo-700 focus:outline-none active:bg-indigo-700">
                              Gioca in anteprima
                          </button>
                      </span>
                  </div>
