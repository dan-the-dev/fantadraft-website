...
const Home: NextPage = () => {
  return (
    <div>
      ...
      <section className="text-gray-200 bg-primary body-font">
          <div className="container flex flex-col items-center px-8 py-8 mx-auto max-w-7xl sm:flex-row">
              <a href="#_" className="text-xl font-black leading-none text-gray-200 select-none logo">tails<span className="text-primary">.</span></a>
